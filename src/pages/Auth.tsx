          ...
          {!isLogin && (
            <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md">
              <p className="text-sm text-blue-700 dark:text-blue-300">
                <strong>💡 Tip:</strong> Create your first account to start using the calculator. 
              ...
              <ul className="mt-2 text-xs text-blue-600 dark:text-blue-400 space-y-1">
                <li>• admin@test.com (Global Admin)</li>
                <li>• user@test.com (Regular User)</li>
                <li>• roleadmin@test.com (Role Admin)</li>
              </ul>
            </div>
          )}
        </div>
